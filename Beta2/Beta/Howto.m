...
-(id)init{
    if (self=[super init]) {
        ...
        self.imageHowtoplay=[CCSprite spriteWithFile:@"play.png"]; //explanation
        self.imageHowtoplay.scale=0.75f;
        self.imageHowtoplay.position=ccp(size.width/2, size.height-60);
